 ...
 * 
 */
@WebServiceClient(name = "UserServiceService", targetNamespace = "http://service.webservice.ai.com/", wsdlLocation = "http://127.0.0.1/services/UserService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICESERVICE_QNAME = new QName("http://service.webservice.ai.com/", "UserServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1/services/UserService?wsdl");
    ...
    public UserService getUserServicePort() {
        return super.getPort(new QName("http://service.webservice.ai.com/", "UserServicePort"), UserService.class);
    }
    ...
    public UserService getUserServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.webservice.ai.com/", "UserServicePort"), UserService.class, features);
    }
